...
<div class="relative shadow-sm rounded-xl overflow-hidden isolate max-w-5xl bg-white h-64 background-fallback">
	<div class="overflow-hidden cursor-pointer bg-tipplers-primary/20 select-none">
